...
'<div id="svga-container" class="svga-no-touch">',
	...
	'<div class="svga-row">',
		...
		'<div class="svga-col-right">',
			...
			'<div class="svga-row">',
				'<div id="svga-footermenu">',
					'<ul>',
						'<li id="svga-randomavatar"><div></div><span class="svga-mobilehidden">',rnd_msg,'</span></li>',
						'<li id="svga-resetavatar"><div></div><span class="svga-mobilehidden">',reset_msg,'</span></li>',
						'<li id="svga-saveavatar"><div></div><span class="svga-mobilehidden">',save_msg,'</span></li>',
						'<li id="svga-shareavatar"><div></div><span class="svga-mobilehidden">',share_msg,'</span></li>',
						'<li id="svga-gravataravatar"><div></div><span class="svga-mobilehidden">',gravatar_msg,'</span></li>',
						'<li id="svga-downloadavatar"><div></div><span class="svga-mobilehidden">',dnl_msg,'</span>',
							'<ul>',
								'<li id="svga-svgfile">',svg_msg,'</li>',
								'<li id="svga-png-two">',png_two_msg,'</li>',
								'<li id="svga-png-one">',png_one_msg,'</li>',
							'</ul>',
						'</li>',
					'</ul>',
				'</div>',
		...
		'</div>',
	'</div>',
	'<p class="svga-credit">',crd_msg,'<a href="http://svgavatars.com" target="_blank" rel="nofollow">svgAvatars.com</a></p>',
	'<div id="svga-start-overlay">&nbsp;</div>',
	'<div id="svga-work-overlay">&nbsp;</div>',
	'<div id="svga-loader">',wait_msg,'</div>',
	'<div id="svga-gender">',
		welcome_slogan,
	...
	'<div id="svga-dialog">',
		...
		'<div id="svga-dialog-btns">',
			'<div id="svga-dialog-ok">',ok_msg,'</div>',
			'<div id="svga-dialog-cancel">',cancel_msg,'</div>',
		'</div>',
	'</div>',
	'<div id="svga-gravatar">',
		gravatar_title,
		'<div id="svga-gravatar-fields">',
				'<input class="svga-input" type="text" id="svga-gravatar-email" value="" placeholder="',gravatar_email,'">',
				'<input class="svga-input" type="password" id="svga-gravatar-pass" value="" placeholder="',gravatar_pwd,'">',
			'<p>',gravatar_rating,'<label class="svga-gr-rating"><input type="radio" name="svga-gr-rating" value="0" checked> G</label>',
		...
		'<div id="svga-gravatar-btns">',
			'<div id="svga-gravatar-ok">',install_msg,'</div>',
			'<div id="svga-gravatar-cancel">',cancel_msg,'</div>',
		'</div>',
	'</div>',
	'<div id="svga-message">',
		'<div id="svga-message-text"></div>',
		'<div class="svga-close">',close_msg,'</div>',
	'</div>',
	'<div id="svga-gravatar-message">',
		'<div id="svga-gravatar-message-text"></div>',
		'<div id="svga-tryagain">',tryagain_msg,'</div>',
	'</div>',
	'<div id="svga-ios">',
	...
	'<div id="svga-share-block">',
		...
		'<ul>',
			'<li id="svga-share-facebook"><a href="#"><span id="svga-facebook-icon"></span></a></li>',
			...
			'<li id="svga-share-googleplus"><a href="#"><span id="svga-googleplus-icon"></span></a></li>',
		'</ul>',
		'<div class="svga-close">',close_msg,'</div>',
	'</div>',
'</div>'
...
$('#svga-controls-eb1').click(function(){
	var cur_group;
	cur_group = SVG.get('svga-group-eyebrows-left');
...
$('#svga-controls-eb2').click(function(){
	var cur_group;
	cur_group = SVG.get('svga-group-eyebrows-left');
...
$('#svga-controls-eb3').click(function(){
	var cur_group;
	cur_group = SVG.get('svga-group-eyebrows-left');
	cur_group.svgaCancelRotate().svgaRotateRight(1,rotate_step/2);
	cur_group = SVG.get('svga-group-eyebrows-right');
...
$('#svga-controls-eb4').click(function(){
	var cur_group;
	cur_group = SVG.get('svga-group-eyebrows-left');
...
$('#svga-controls-ebcancel').click(function(){
	var cur_group;
	cur_group = SVG.get('svga-group-eyebrows-left');
